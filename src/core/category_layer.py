...
In the BL3 design, the category layer is the base text layer from which
...
def ensure_or_generate_category_name(
    ...
    *,
    ...
    This is used by the HierarchyEngine to support:
        - "Use an existing category column"
        - "Auto-generate categories for me"
    """
    df_out = df.copy()
    ...
    df_temp = assign_all_subclusters(
        df_temp,
        random_state=42,
